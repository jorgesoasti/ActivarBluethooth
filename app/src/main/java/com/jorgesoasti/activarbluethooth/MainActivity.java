package com.jorgesoasti.activarbluethooth;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int CODIGO_SOLITUD_PERMISO = 1;
    ...
    public void solicitarPermiso(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.BLUETOOTH)){
            ...
            ActivityCompat.requestPermissions(activity, new String[] {Manifest.permission.BLUETOOTH}, CODIGO_SOLITUD_PERMISO);
        }
    }
